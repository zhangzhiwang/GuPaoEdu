...
//			commandProperties = {
//			@HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds", value = "3000")// 设置超时时间。@HystrixCommand注解的属性commandProperties的类型也是一个注解，所以使用@HystrixProperty
//			})
	...
	public String fallBackTest() {// 降级方法的入參和返回值类型必须和原方法一致，名称和原方法的@HystrixCommand注解的fallbackMethod属性一致
		return "【默认】服务降级了";
	}
}
